...
| Domain-block trigger determinism | Contract-level decision on fence-vs-weave for borderline turns: whether the model should deterministically fence domain context or may weave it into a doc-anchored answer. | drift-01/coverage-01 fenced a domain block in run 141138 but not 122252 — the trigger is non-deterministic; the eval now records it as informational (domain_block_optional) rather than asserting it. |
